-- ================================================================
-- iTradeCoach Complete Database Schema (Fixed for Ownership Issues)
-- ================================================================
-- 
...
-- ================================================================
-- SECTION 9: UTILITY FUNCTIONS (WITH OWNERSHIP HANDLING)
-- ================================================================

-- Check if update_updated_at_column function exists and create it if not
DO $$
BEGIN
    -- Try to create the function, ignore if it already exists
...
EXCEPTION
    WHEN duplicate_function THEN
        -- Function already exists, that's fine
        NULL;
    WHEN insufficient_privilege THEN
        -- We don't own the function, but it exists, so we can use it
        NULL;
END $$;

-- Alternative approach: Create a custom update function with a unique name
...
-- ================================================================
-- SECTION 11: TRIGGERS (USING CUSTOM FUNCTION FOR UPDATED_AT)
-- ================================================================
...
-- View for public platform stats
