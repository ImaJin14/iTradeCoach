// components/tutor/LiveSession.tsx - Fixed click to expand functionality
"use client";
...
export function LiveSession({ 
  ...
  useEffect(() => {
    ...
    if (iframe) {
      const handleLoad = () => {
        ...
        toast({
          title: "Connected!",
          description: "You're now connected with your AI tutor.",
        });
      };
      ...
      const handleError = () => {
        ...
        toast({
          ...
          description: "Failed to connect to the live session.",
          variant: "destructive",
        });
      };
  ...
  const handleEndSession = async () => {
    try {
      ...
      toast({
        title: "Session Ended",
        description: `Your live tutoring session lasted ${formatDuration(duration)}.`,
      });
  ...
  const getSessionTitle = () => {
    if (topic) {
      return `Live Session: ${topic}`;
    }
    return sessionType === 'follow_up' ? 'Follow-up Session' : 'Live Tutoring Session';
  };
          ...
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-sm">Live with iTrader</CardTitle>
              ...
              <div className="flex gap-1">
                <Button
                  ...
                  onClick={(e) => {
                    e.stopPropagation(); // Prevent card click when clicking maximize button
                    setIsMinimized(false);
                  }}
                ...
                <Button
                  ...
                  onClick={(e) => {
                    e.stopPropagation(); // Prevent card click when clicking end button
                    handleEndSession();
                  }}
                  title="End session"
                >
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <p className="text-xs text-muted-foreground">
                  Click anywhere to expand your live tutoring session
                </p>
                {topic && (
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {sessionStatus === 'connecting' && 'Connecting to your AI tutor...'}
            ...
            {isLoading && (
              <div className="absolute inset-0 flex items-center justify-center bg-muted/50 backdrop-blur-sm z-10">
                <div className="text-center space-y-4">
                  ...
                  <div>
                    <p className="font-medium">Connecting to iTrader...</p>
                    <p className="text-sm text-muted-foreground">
                      {topic ? `Preparing to discuss ${topic}` : 'Setting up your live tutoring session'}
                    </p>
                    <p className="text-xs text-muted-foreground mt-1">
                      iTrader will start the conversation about your chosen topic
                    </p>
                  </div>
                </div>
              </div>
