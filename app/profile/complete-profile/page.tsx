...
//   // app/profile/complete-profile/page.tsx
...
//         .upsert({
//           coach_id: user.id,
//           expertise_areas: [], // Default empty array
...
//           subscription_active: false, // Default to false
//           subscription_required: false, // Default to false
//           algorand_wallet: null, // Default to null
//           video_intro_url: null, // Default to null
//           created_at: new Date().toISOString(),
//           updated_at: new Date().toISOString(),
//         }, {
//           onConflict: 'coach_id'
...
//           tokens_earned: 0,          // Default to 0
//           courses_completed: [],     // Default empty array
//           learning_goals: [],        // Default empty array
//           selected_coach_id: null,   // Default to null
//           selected_path: null,       // Default to null
//           subscription_required: false, // Default to false
//           created_at: new Date().toISOString(),
//           updated_at: new Date().toISOString(),
//         }, {
